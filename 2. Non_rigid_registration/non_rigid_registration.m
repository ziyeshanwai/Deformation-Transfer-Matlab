function [ VSP2 VT S_factor T_factor ] = non_rigid_registration( VS, FS, VT, FT, ws, wi, wc, marker, Name, vis)
...
if vis
    ...
    title("inspect marker in source mesh");
    figure; 
    ...
    title("inspect marker in target mesh");
    hold off;
end
